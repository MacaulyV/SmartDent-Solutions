...
namespace SmartDentAPI.Controllers
{
    ...
    /// </summary>
    /// <remarks>
    /// Este controller fornece endpoints para gerenciar o cadastro completo de pacientes,
    /// incluindo criação, consulta, atualização e exclusão de registros.
    /// </remarks>
    [Route("api/Pacientes")]
    [ApiController]
    [SwaggerTag("Pacientes")]
    public class PacientesController : ControllerBase
    {
        ...
        /// <response code="400">Erro na solicitação - dados inválidos</response>
        [HttpPost]
        [SwaggerResponse(201, "Paciente criado com sucesso", typeof(PacienteResponseDTO))]
        [SwaggerResponse(400, "Requisição inválida", typeof(object))]
        [SwaggerOperation(
            Summary = "Criar novo paciente",
            Description = "Cadastra um novo paciente no sistema com as informações fornecidas",
        ...
        /// </summary>
        /// <returns>Lista de fichas dos pacientes individuais.</returns>
        /// <remarks>
        ...
        [SwaggerOperation(
            Summary = "Obter fichas de pacientes individuais",
            Description = "Retorna dados detalhados de todos os pacientes com plano individual",
            OperationId = "GetFichaPacientesIndividuais",
            Tags = new[] { "Pacientes" }
        )]
