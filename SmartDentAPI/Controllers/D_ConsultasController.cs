...
namespace SmartDentAPI.Controllers
{
    ...
    public class ConsultasController : ControllerBase
    {
        ...
        /// <response code="400">Erro de validação dos dados ou paciente não encontrado</response>
        [HttpPost]
        [SwaggerResponse(201, "Consulta criada com sucesso", typeof(ConsultaResponseDTO))]
        ...
        [HttpGet]
        [SwaggerResponse(200, "Lista de consultas", typeof(List<ConsultaResponseDTO>))]
        [SwaggerOperation(
        ...
        /// <response code="200">Consulta encontrada com sucesso</response>
        /// <response code="404">Consulta não encontrada</response>
        [HttpGet("{id}")]
        [SwaggerResponse(200, "Consulta encontrada", typeof(ConsultaResponseDTO))]
        [SwaggerResponse(404, "Consulta não encontrada", typeof(object))]
        [SwaggerOperation(
            Summary = "Obter consulta por ID",
            Description = "Retorna os dados de uma consulta específica baseado no ID",
        ...
        /// <response code="400">Erro de validação dos dados</response>
        /// <response code="404">Consulta não encontrada</response>
        [HttpPut("{id}")]
        [SwaggerResponse(200, "Consulta atualizada com sucesso", typeof(ConsultaResponseDTO))]
        [SwaggerResponse(400, "Requisição inválida", typeof(object))]
        [SwaggerResponse(404, "Consulta não encontrada", typeof(object))]
        [SwaggerOperation(
            Summary = "Atualizar consulta",
            Description = "Atualiza os dados de uma consulta existente, incluindo data e status",
        ...
        /// </summary>
        /// <remarks>
        /// Este endpoint remove uma consulta do sistema e decrementa o contador de consultas do paciente.
        /// </remarks>
        /// <param name="id">ID da consulta a ser excluída.</param>
        /// <returns>Status 204 (No Content) se a exclusão for bem-sucedida ou erro.</returns>
        /// <response code="204">Consulta excluída com sucesso</response>
        /// <response code="404">Consulta não encontrada</response>
        /// <response code="400">Erro ao tentar excluir a consulta</response>
        [HttpDelete("{id}")]
        [SwaggerResponse(204, "Consulta excluída com sucesso")]
        [SwaggerResponse(404, "Consulta não encontrada", typeof(object))]
        [SwaggerResponse(400, "Erro ao excluir consulta", typeof(object))]
        [SwaggerOperation(
            Summary = "Excluir consulta",
            Description = "Remove uma consulta do sistema e atualiza o contador de consultas do paciente",
