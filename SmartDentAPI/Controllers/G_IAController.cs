...
namespace SmartDentAPI.Controllers
{
    ...
    public class AnaliseIAController : ControllerBase
    {
        ...
        [SwaggerOperation(
            Summary = "Analisar uso via JSON",
            Description = "Recebe um payload JSON e encaminha para análise de IA",
            OperationId = "AnalisarUsoJson",
            Tags = new[] { "AnaliseIA" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Analisar paciente por ID",
            Description = "Busca a ficha completa de um paciente e envia para análise",
            OperationId = "AnalisarPaciente",
            Tags = new[] { "AnaliseIA" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Analisar pacientes com plano individual",
            Description = "Analisa todos os pacientes com plano individual",
            OperationId = "AnalisarPacientesIndividuais",
            Tags = new[] { "AnaliseIA" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Analisar pacientes por empresa",
            Description = "Analisa todos os pacientes de uma empresa específica",
            OperationId = "AnalisarPacientesPorEmpresa",
            Tags = new[] { "AnaliseIA" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Analisar pacientes por cidade",
            Description = "Analisa todos os pacientes de uma cidade específica",
            OperationId = "AnalisarPacientesPorCidade",
            Tags = new[] { "AnaliseIA" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Analisar todos os pacientes",
            Description = "Analisa todos os pacientes cadastrados no sistema",
            OperationId = "AnalisarTodosPacientes",
            Tags = new[] { "AnaliseIA" }
        )]
