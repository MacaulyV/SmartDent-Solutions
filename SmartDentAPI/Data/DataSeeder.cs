        ...
        public static async Task SeedDatabase(IServiceProvider serviceProvider)
        {
            ...
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                try 
                {
                    ...
                    logger.LogInformation("DataSeeder: Iniciando processo de seed para novos pacientes...");
                    ...
                    // Loop para criar 1 pacientes com dados e consultas aleatórias.
                    for (int i = 0; i < 0; i++)
                    {
                ...
                {
                    logger.LogError(ex, "DataSeeder: Ocorreu um erro ao executar o seed.");
                }
            }
        }
    }
